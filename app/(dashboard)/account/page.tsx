              ...
              <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
                ...
                <DialogContent className="sm:max-w-md">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Send XLM from an external wallet to your public address on
                      Stellar testnet
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-info/10 border border-info/20 rounded-lg flex gap-3">
                      ...
                      <div className="text-sm text-muted-foreground">
                        ...
                        <p>
                          Send at least 1 XLM from an external wallet to the
                          address above on Stellar testnet.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <Button
                      ...
                      disabled={
                        !withdrawDestination || !withdrawAmount || isWithdrawing
                      }
                      className="w-full"
                    >
