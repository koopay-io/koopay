...
const teamMembers = [
  {
    ...
    image: '/avatars/steven-molina.png',
  },
  {
    name: 'Tomas Salina',
    ...
    image: '/avatars/tomas-salina.png',
  },
  {
    name: 'Renzo Barcos',
    role: 'Full-Stack Developer',
    ...
    image: '/avatars/renzo-barcos.png',
  },
  {
    ...
    image: '/avatars/micaela-descotte.png',
  },
];
      ...
      <div className="relative max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-xl text-zinc-300/85 max-w-4xl mx-auto">
            Koopay is built by a passionate team of young builders from Buenos Aires, combining
            blockchain expertise, full-stack development, and Web3 design. Together, we are shaping
            a secure, seamless, and fair freelancing experience for the next generation of global
            work.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-white/12 bg-gradient-to-br from-slate-900/80 via-[#0b1120]/70 to-slate-900/60 p-8 md:p-12 shadow-[0_40px_120px_-65px_rgba(59,130,246,0.85)] backdrop-blur-2xl text-center">
          ...
          <p className="text-lg text-zinc-300/85 max-w-2xl mx-auto mb-8">
            We collaborate openly with freelancers, founders, and partners who believe in
            trust-first payments. Reach out if you are exploring ecosystem partnerships, beta
            testing, or strategic support.
          </p>
          <a
            href="mailto:team@koopay.xyz"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-1 text-white text-xs font-semibold uppercase tracking-wide rounded-full shadow-[0_22px_55px_-20px_rgba(79,70,229,0.85)] hover:brightness-110"
          >
