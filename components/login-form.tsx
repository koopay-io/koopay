...
export function LoginForm({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) {
  ...
  const OAuthButtons = () => (
    <div className="flex flex-col gap-3">
      <div className="relative">
        <p className="text-center text-sm text-muted-foreground my-3">or</p>
      </div>
      <Button
        type="button"
        variant="secondary"
  ...
  return (
    <div className={cn('w-full max-w-md flex gap-4 sm:gap-5 md:gap-6', className)} {...props}>
      <Card
        className="w-full border-none bg-black/10 mix-blend-overlay py-6 px-5 sm:py-8 sm:px-6 md:py-10 md:px-8 lg:py-16 lg:px-16"
        style={{
      ...
      >
        ...
        <CardHeader className="px-0 pb-3 sm:pb-4 md:pb-5">
          <CardTitle className="text-xl sm:text-2xl md:text-3xl lg:text-3xl 3xl:text-4xl w-full sm:w-auto">
              ...
              <div className="flex flex-col gap-4 sm:gap-5 md:gap-6">
                <div className="grid gap-2">
                  <Input
                    ...
                    className="bg-[#101b40] border-0 outline-0 rounded-full px-4 sm:px-5 md:px-6 py-3 sm:py-4 md:py-[18px] text-base placeholder:text-white placeholder:font-normal font-bold hover:outline-0 focus-visible:ring-0"
                  />
                </div>
                  ...
                  <div className="flex justify-center">
                    <InputOTP maxLength={6} value={otp} onChange={(value) => setOtp(value)}>
                      <InputOTPGroup>
                        <InputOTPSlot
                          index={0}
                          className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 text-base sm:text-lg"
                        />
                        <InputOTPSlot
                          index={1}
                          className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 text-base sm:text-lg"
